...
if(!isset($_SESSION['access_token']))
{
 ...
 $login_button = '<a href="'.$google_client->createAuthUrl().'"style="background:#dd4b39; border-radius: 20px; color: #000; display:block; font-weigth:bold; padding: 7px; text-align:center; text-decoration:none; width: 200px;position: relative; left: 450px; top: 60px">Login With Google</a>';
}
?>
...
.p-2:hover{
  ...
  <div class="container">
   ...
   if($login_button == '')
   {
    ...
    echo '<img src="'.$_SESSION["user"].'" class="img-responsive img-circle img-thumbnail" />';
    echo '<h3><b>Name :</b> '.$_SESSION['user_first_name'].' '.$_SESSION['user_last_name'].'</h3>';
    echo '<h3><b>Email :</b> '.$_SESSION['user_email_address'].'</h3>';
    echo '<h3><a href="out.php">Logout</h3></div>';
   }
   else
   {
